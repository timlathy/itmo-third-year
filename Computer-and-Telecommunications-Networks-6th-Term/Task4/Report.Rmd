...
Настройки узлов приведены на рисунках 7-9.
...
Настройки узлов приведены на рисунках 7, 10, 11.

### Настройки узлов вариативной части

![Рис. 7. Настройки адресации (IPv4 и IPv6)](v1-ip.png)

![Рис. 8. Настройки iptables (IPv4)](v1-iptables.png)

![Рис. 9. Таблицы маршрутизации (IPv4)](v1-ip-rules.png)

![Рис. 10. Настройки iptables (IPv6)](v1-iptables-v6.png)

![Рис. 11. Таблицы маршрутизации (IPv6)](v1-ip-rules-v6.png)