...
```{r}
plot(labacf, type = "b", xlab = "Сдвиг последовательности", ylab = "Коэффициент автокорреляции")
```
...
plot(labpdf$x, labpdf$y, col = "black", lwd = 2, type = "h", xlab = "Интервалы", ylab = "Плотность")
...
writecf(approxacf)
plot(approxacf, type = "b", xlab = "Сдвиг последовательности", ylab = "Коэффициент автокорреляции")
```
